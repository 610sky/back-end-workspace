...
public class Application {
	...
	public void memberMenu(String name) throws SQLException {
		boolean check = true;
		while(check) {
	...
	public void changePassword(String name) throws SQLException {
		...
		if(mc.changePassword(id, password, newPassword, name)) {
	...
	public void changeName(String name) throws SQLException {
		...
		if(!mc.search(id,password)) {
			System.out.println("현재 설정된 이름 : " + name);
			System.out.print("변경할 이름 : ");
			String changeName = sc.nextLine();
			
			if(mc.changeName(id, password, changeName)!=null) {
