...
public class Application {
	 ...
	 * 2. 캡슐화 : 객체의 속성(필드)와 기능(메서드)을 하나로 묶고
	 * 			  실제 구현 내용을 감추는 것
	 ...
	 * - 접근제한자 public, default, private, protected 등 설정 가능
	 * - 클래스는 필드(Field), 메서드(Method), 생성자(Constructor)가 정의
	 * - 클래스 작성 시 객체 지향 언어 특징 중 추상화(Abstraction),
	...
	public static void main(String[] args) {
		...
		tv.channelDown();
		tv.channelUp();
		System.out.println("TV 상태 : " + tv.channel); // 2번
	}
}
