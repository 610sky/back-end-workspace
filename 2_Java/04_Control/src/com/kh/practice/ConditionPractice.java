...
//   			return;  => 프로그램 종료시킴
    ...
    public void method11() {
    	...
    	int assgn_score = sc.nextInt();
    	System.out.print("출석 횟수 : ");
    	int attend = sc.nextInt();
    	
    	double total_score = mid_score*0.2 + final_score*0.3 + assgn_score*0.3 + attend;
    	
    	if(attend >= 14 && total_score >= 70) {
    		System.out.println("========결과========");
    		System.out.println("중간 고사 점수(20) : " + mid_score*0.2);
    		System.out.println("기말 고사 점수(30) : " + final_score*0.3);
    		System.out.println("과제 점수(30) : " + assgn_score*0.3);
