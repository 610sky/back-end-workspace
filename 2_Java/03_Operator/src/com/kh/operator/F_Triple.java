...
public class F_Triple {
	...
	public void method1() {
		...
		System.out.println(result = number == 0 ? "0이다" : result);
...
//		다른 방법 1 (if문)
		if(ch == '+' || ch == '-') {
			System.out.printf("%d %c %d = %d", num1, ch, num2, 
		...
		System.out.println();
//		다른 방법 2
		result = ch == '+' ? String.format("%d + %d = %d",num1,num2,(num1+num2)) :
