...
CREATE TABLE book(
    ...
    bk_price INT,
    bk_pub_no INT,
    CONSTRAINT pub_no_fk FOREIGN KEY (bk_pub_no) REFERENCES publisher(pub_no)
    ON DELETE CASCADE
);
INSERT INTO book(bk_title, bk_author, bk_price, bk_pub_no)
VALUES('개발자를 위한 생각의 정리, 문서작성법', '카이마이 미즈히로', '20000', 1);
INSERT INTO book(bk_title, bk_author, bk_price, bk_pub_no)
VALUES('1일 1로그 100일 완성 IT 지식', '브라이언 W. 커니핸', '20000', 2);
INSERT INTO book(bk_title, bk_author, bk_price, bk_pub_no)
